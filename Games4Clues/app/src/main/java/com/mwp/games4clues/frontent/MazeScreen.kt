...
import com.mwp.games4clues.frontent.DefaultScreenLayout
import com.mwp.games4clues.model.MazeGameState
import com.mwp.games4clues.viewmodel.MazeGameViewModel
import com.mwp.games4clues.viewmodel.providers.MazeGameViewModelFactory

@Composable
fun MazeScreen(navController: NavController, mazeMatrix: List<List<Int>>) {
    val viewModel: MazeGameViewModel = viewModel(factory = MazeGameViewModelFactory(mazeMatrix))
    val state by viewModel.state.collectAsState()

    DefaultScreenLayout(title = "Maze Game") { modifier ->
